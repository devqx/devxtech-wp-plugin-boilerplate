...
<div class="form-group">
  <label for="userpasswordname">Choose Password</label>
...
<div class="form-group">
  ...
  <span style="padding-left:10px">I Agree To <a hre="#">The Terms and Conditions</a>
  </span>
  </label>
...
<div class="form-group">
  ...
  <input type="text" name="account_name" id="account_name" class="form-control" placeholder="" required>
</div>
...
<div class="form-group">
  <label for=""></label>
  <input type="submit" name="submit" id="submit" class="form-control btn  btn-warning" value="Register" >
</div>
